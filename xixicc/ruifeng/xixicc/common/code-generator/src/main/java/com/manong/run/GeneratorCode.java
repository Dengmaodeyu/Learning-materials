...
public class GeneratorCode {
    private static String author ="pcc";//作者名称
    private static String outputDir ="C:\\Users\\jmscadmin\\Desktop\\project\\xixicc\\ruifeng\\xixicc\\service\\service_auth\\src\\main\\java";//生成的位置
    private static String driver ="com.mysql.cj.jdbc.Driver";//驱动，注意版本
    //连接路径,注意修改数据库名称
    private static String url ="jdbc:mysql://43.138.206.79:3307/xixi_auth?useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC";
    private static String username ="root";//数据库用户名
    private static String password ="root";//数据库密码
    private static String tablePrefix ="xixi";//数据库表的前缀，如t_user
    private static String [] tables = {"xixi_user"};   //生成的表
    private static String parentPackage = "com.xixicc.authservice";//顶级包结构
